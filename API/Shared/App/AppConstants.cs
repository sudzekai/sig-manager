...
namespace Shared.App
{
    public static class AppConstants
    {
        ...
        public const string ChangeLog =
            """
            Добавлены модели Role, Right, Position и схемы для них

            Введены новые доменные модели с валидацией. 
            Реализованы схемы и селекты для Role, Right, Position и связующей таблицы RoleRight. 
            В DataValidator добавлены методы Min/Max для decimal.
            """;
